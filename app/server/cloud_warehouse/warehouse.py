...
def get_main_warehouse():
    ...
    req_url = api_url + "/repos/weilin9999/WeiLin-Comfyui-Tools-Prompt/git/trees/master"
...
def get_warehouse_tree(path):
    ...
    req_url = api_url + "/repos/weilin9999/WeiLin-Comfyui-Tools-Prompt/contents/"+path
    response = requests.get(req_url, headers=headers)
    response.raise_for_status()
    return response.json()
