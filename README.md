...
> 0.0.80 公测版本介绍 如果你要使用本插件请务必进我们的官方 QQ 群（905656521）！

> 1. 修复新版本ComfyUI节点的BUG PR [#83](https://github.com/weilin9999/WeiLin-Comfyui-Tools/pull/83) 感谢各位小伙伴的帮助

<details>
<summary>点击查看往期更多更新内容</summary>


> 0.0.77/0.0.78/0.0.79 公测版本介绍 2026-06-27
>
...
>
> 8. 修复提示词隐藏之后修改提示词会导致隐藏提示词位置变动的BUG
>
> 9. 修复自动补全BUG，如果提示词是隐藏的输入同样的提示词补全的时候会把隐藏的提示词位置变到自动补全的位置上
>
